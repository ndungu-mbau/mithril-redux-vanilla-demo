...
var FILTER_TODO_LIST = exports.FILTER_TODO_LIST = 'FILTER_TODO_LIST';
...
var setVisibilityFilter = exports.setVisibilityFilter = function setVisibilityFilter(filterName) {
  return {
...
exports.todoApp = exports.initialState = undefined;
...
var todoApp = exports.todoApp = function todoApp() {
  ...
  switch (action.type) {
    case _actions.FILTER_TODO_LIST:
...
var FilterButton = {
  view: function view(_ref) {
    ...
    return (0, _mithril2.default)('button', {
      onclick: function onclick() {
        return attrs.toggleList(attrs.type);
      }
    }, attrs.type);
  }
};
...
exports.default = {
  ...
  view: function view(_ref3) {
    ...
    return (0, _mithril2.default)('div.filter-buttons', [Object.values(_actions.VisibilityFilters).map(function (filter) {
      return (0, _mithril2.default)(FilterButton, {
        toggleList: function toggleList(type) {
          return _this.dispatch((0, _actions.setVisibilityFilter)(type));
        },
        type: filter
      });
    })]);
...
var Todo = {
  view: function view(_ref) {
    ...
    return (0, _mithril2.default)('li', [(0, _mithril2.default)('button', { onclick: function onclick() {
        return attrs.store.dispatch((0, _actions.toggleTodo)(attrs.index));
      } }, 'X'), (0, _mithril2.default)('p', { class: attrs.todo.completed ? 'line-through' : '' }, attrs.todo.text)]);
  }
};
...
exports.default = {
  view: function view(_ref2) {
    ...
    var _attrs$store$getState = attrs.store.getState(),
        todos = _attrs$store$getState.todos,
        visibilityFilter = _attrs$store$getState.visibilityFilter;

    return (0, _mithril2.default)('ul', todos.filter(function (todo) {
      ...
      return (0, _mithril2.default)(Todo, { todo: todo, index: i, store: attrs.store });
    }));
  }
};
...
_mithril2.default.mount(root, {
  view: function view() {
    return (0, _mithril2.default)("div.container", [(0, _mithril2.default)(_AddTodo2.default, { store: _store2.default }), (0, _mithril2.default)(_TodoList2.default, { store: _store2.default }), (0, _mithril2.default)(_FilterButtons2.default, { store: _store2.default })]);
  }
});
...
//# sourceMappingURL=/src.f90490ac.map